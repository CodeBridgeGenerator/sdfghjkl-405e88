...
const avatarTemplate0 = (rowData, { rowIndex }) => <Avatar image={rowData.name}  />
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.roles?.name}</p>
...
<Column field="name" header="name" body={avatarTemplate0} sortable style={{ minWidth: "8rem" }} />
<Column field="roles" header="roles" body={pTemplate1} style={{ minWidth: "8rem" }} />
